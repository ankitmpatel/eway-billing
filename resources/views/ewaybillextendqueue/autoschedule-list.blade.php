...
@section('content_header')
    <h1>Extend E-Way Bills (Schedule time - 
        ...
        <div class="col-md-12">
            <div class="card p-2">
                <div class="card_header filters">
                    <div class="row">
                        <div class="col-1">
                            <a href="{{route('ewaybillextendqueue.autoschedule')}}" class="btn btn-warning pull-left">Back</a>
                        </div>
                        <div class="col-10">
                        </div>
...
var oTable = $('#list').DataTable( {
        ...
        "searching": true,
        "ajax": {
            url: '{{route('ewaybillextendqueue.autoschedule.list')}}',
            data: function (d) {
...
let extend_url = '{{ route('ewaybill.extend.schedule') }}';
