...
@section('content_header')
    <h1>Update Transporter (E-Way Bills)</h1>
@stop
        ...
        <div class="col-md-12">
            <div class="card p-2">
                <div class="card_header filters">
                    ...
                    class="btn btn-primary" name="extend" value="Update Transporter">
                    </div>
                    </div>
                    <hr/>
                </div>
...
var oTable = $('#list').DataTable( {
        ...
        "searching": true,
        "ajax": {
            url: '{{route('updatetranspoerter.index')}}',
            data: function (d) {
...
let extend_url = '{{ route('updatetranspoerter.update') }}';
